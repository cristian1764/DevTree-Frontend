        ...
        >
            ...
            <div className="grid grid-cols-1 space-y-3">
                ...
                <input
                    ...
                    {...register('email',{required:"Tu correo es obligatorio",
                      pattern:{
                          value: /\S+@\S+\.\S+/,
            ...
            <div className="grid grid-cols-1 space-y-3">
                ...
                <input
                    ...
                    {...register('password',{required:"Tu contraseña es obligatorio",
                      minLength:{
                        value:8,
                        message: "El password debe de ser minimo de 8n caracteres"
                      }
                    })}
            ...
            <div className="grid grid-cols-1 space-y-3">
                ...
                <input
                    ...
                    {...register('password_confirmation',{required:"verificar tu password es necesario",
